...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNacionalidad = new JComboBox<String>(new String[] { "afgano-afgana", "alemán-alemana",
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				LocalDate fechaNacimiento = txtFechaN.getDate().toInstant().atZone(ZoneId.of("America/Chicago"))
						.toLocalDate();
				...
				if (huespedDao.guardar(huesped)) {
					Exito exitowindow = new Exito();
					exitowindow.setVisible(true);
					dispose();
				} else {
					JOptionPane.showMessageDialog(contentPane, "Ocurrio un error, por favor intente de nuevo");
				}
			}
		});
